 ...
 * @LastEditTime: 2024-11-26 09:13:55
    ...
    <div class="kvm-page-header flex-btw">
        ...
        <div class="flex">
            <div class="info-box flex-start">
                <a-tooltip :title="msgStore?.connected ? 'Connected' : 'Disconnected'">
                    <img :src="linkSvgSrc" :class="{ 'link-img': true, 'img-enabled': msgStore?.connected }" alt="">
                </a-tooltip>
                <a-tooltip :title="kvmStore.streamStateTitle">
                    <img :src="streamSvgSrc"
                        :class="{ 'link-img': true, 'stream-status': true, 'img-enabled': kvmStore.streamState }" alt="">
                </a-tooltip>
                <a-tooltip :title="kvmStore.streamStateTitle">
                    <img :src="mouseSvgSrc"
                        :class="{ 'link-img': true, 'stream-status': true, 'img-enabled': kvmStore.mouseEnabled }" alt="">
                </a-tooltip>
            </div>
...
import mouseSvgSrc from '@/assets/imgs/led-hid-mouse.svg'
